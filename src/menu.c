...
#define PACKAGE_VERSION "0.7.5.1"
#endif
...
static const char MENU_RELEASE_DATE[] =  "07-08-2013";
...
static const OPTDOC MENU_OPTDOC_MAP[] = {
  ...
  vnam:"ouform",
#ifdef HAVE_BAMBAMC
  sdesc: "Output format [sam(default)|bam|cigar|gff|ssaa].\n"\
  ...
  "     (see manual).\n"
#else
  sdesc: "Output format [sam|cigar|gff|ssaa]. Extension sam:nohead,clip.",
  ldesc:								\
